...
from employees as e 
join departments as d where  d.dept_id = e.dept_id order by e.emp_name;
...
| Oscar    | NULL      |
*/
 select e.emp_name , d.dept_name from employees as e left join 
...
| Sales     | 3               |
*/
select d.dept_name, count(*) as total_employees from employees as e join departments as d 
...
| Grace   | 1         |
*/
select  m.emp_name , count(*) as total
